...
const LandingPage = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-background to-secondary-light min-h-screen">
      ...
      <header className="container mx-auto mt-16 px-4 sm:px-6 py-16 md:py-20 text-center md:text-left pt-28">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10">
          ...
          <div className="md:w-1/2 md:ml-10">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
              ...
              <a
                href="/about"
                className="bg-white text-black px-6 py-3 rounded-md text-lg font-semibold border border-gray-300 hover:bg-gray-200 transition duration-200 sm:ml-4"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="mt-6 md:mt-10 md:w-2/3 lg:w-3/4 flex justify-center">
            <video
              src="/hero-video.mp4"
              autoPlay
              muted
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 md:py-16">
        ...
        <div className="flex flex-col md:flex-row md:space-x-8 gap-6">
          ...
          {/* Feature 2 */}
          <div className="flex-1 text-center bg-white p-6 rounded-md shadow-lg md:mt-0 hover:shadow-2xl transition-shadow duration-300">
